...
class Test_SQLStatements(unittest.TestCase):
    ...
    def test_question3(self):
        order1 = [(77, 'Original Frankfurter grüne Soße', 12, 2, '12 boxes', 13, 32, 0, 15, 0), (76, 'Lakkalikööri', 23, 1, '500 ml', 18, 57, 0, 20, 0), (75, 'Rhönbräu Klosterbier', 12, 1, '24 - 0.5 l bottles', 7.75, 125, 0, 25, 0), (74, 'Longlife Tofu', 4, 7, '5 kg pkg.', 10, 4, 20, 5, 0), (73, 'Röd Kaviar', 17, 8, '24 - 150 g jars', 15, 101, 0, 5, 0), (72, 'Mozzarella di Giovanni', 14, 4, '24 - 200 g pkgs.', 34.8, 14, 0, 0, 0), (71, 'Flotemysost', 15, 4, '10 - 500 g pkgs.', 21.5, 26, 0, 0, 0), (70, 'Outback Lager', 7, 1, '24 - 355 ml bottles', 15, 15, 10, 30, 0), (69, 'Gudbrandsdalsost', 15, 4, '10 kg pkg.', 36, 26, 0, 15, 0), (68, 'Scottish Longbreads', 8, 3, '10 boxes x 8 pieces', 12.5, 6, 10, 15, 0)]
        order2 = [(10, 'Ikura', 4, 8, '12 - 200 ml jars', 31, 31, 0, 0, 0), (9, 'Mishi Kobe Niku', 4, 6, '18 - 500 g pkgs.', 97, 29, 0, 0, 1), (8, 'Northwoods Cranberry Sauce', 3, 2, '12 - 12 oz jars', 40, 6, 0, 0, 0), (7, "Uncle Bob's Organic Dried Pears", 3, 7, '12 - 1 lb pkgs.', 30, 15, 0, 10, 0), (6, "Grandma's Boysenberry Spread", 3, 2, '12 - 8 oz jars', 25, 120, 0, 25, 0), (5, "Chef Anton's Gumbo Mix", 2, 2, '36 boxes', 21.35, 0, 0, 0, 1), (4, "Chef Anton's Cajun Seasoning", 2, 2, '48 - 6 oz jars', 22, 53, 0, 0, 0), (3, 'Aniseed Syrup', 1, 2, '12 - 550 ml bottles', 10, 13, 70, 25, 0), (2, 'Chang', 1, 1, '24 - 12 oz bottles', 19, 17, 40, 25, 0), (1, 'Chai', 1, 1, '10 boxes x 20 bags', 18, 39, 0, 10, 0)]

        self.assertIn(hw.question3(), [order1, order2])
